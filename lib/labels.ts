...
export function channelLabel(channel: string, locale: Locale = 'ko'): string {
  switch (channel) {
    case 'xiaohongshu': return translate(locale, 'channel.xiaohongshu');
    case 'dianping': return translate(locale, 'channel.dianping');
    case 'douyin': return translate(locale, 'channel.douyin');
